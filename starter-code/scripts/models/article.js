(function(module) {
  ...
  Article.createTable = function() {
    ...
    webDB.execute(
     ...
     'authorUrl TEXT, ' +
     'publishedOn INTEGER, ' +
     'body TEXT);', // TODO: What SQL command do we run here inside these quotes?
      function() {
  ...
  Article.prototype.insertRecord = function() {
    webDB.execute(
      [{
        ...
        'sql': 'INSERT INFO articleTable (title, category, author, authorUrl, publishedOn, body) VALUES (?, ?, ?, ?, ?, ?);', // <----- TODO: complete our SQL query here, inside the quotes.
  ...
  Article.fetchAll = function(nextFunction) {
    webDB.execute(
      'SELECT * FROM articleTable;', // <-----TODO: fill these quotes to query our table.
      function(rows) {
