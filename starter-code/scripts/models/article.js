(function(module) {
  ...
  Article.createTable = function() {
    ...
    webDB.execute(
    'CREATE TABLE if not exists articles (id INTEGER PRIMARY KEY, title VARCHAR, category VARCHAR, author VARCHAR, authorURL VARCHAR, publishedOn VARCHAR, body VARCHAR);',
